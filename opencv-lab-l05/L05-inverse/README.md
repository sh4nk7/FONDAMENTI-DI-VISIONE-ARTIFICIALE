...
## ▶️ Esecuzione
```
./lab5_2 <image_filename> <camera_params_filename>
```
Esempi:
```bash
./lab5_2 ../data/gas.jpg ../data/gas_params.txt
./lab5_2 ../data/ice.jpg ../data/ice_params.txt
./lab5_2 ../data/numbers.jpg ../data/numbers_params.txt
```
Argomenti:
...
Inoltre salva automaticamente il risultato finale nella cartella:

out/<nomefile>_out.png
...
Il laboratorio realizza una trasformazione prospettica inversa completa, mostrando visivamente e numericamente come una singola immagine possa essere convertita in una rappresentazione metrica del piano del suolo.
